...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        <div class="flex items-center">
            <h2 class="ml-1 sm:ml-4 text-lg text-gray-600 leading-7 font-semibold">仕事メニュー</h2>
        </div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
        <div class="flex items-center">
            <h2 class="ml-1 sm:ml-4 text-lg text-gray-600 leading-7 font-semibold">制作実績</h2>
        </div>
