...
return [
    [
        'title' => 'Webシステム開発',
        'text' => '<a href="https://pcs-miraizu.com/" class="underline underline-offset-2" target="_blank">PCSサイト</a>やここのようなプログラマー／エンジニアによるWebシステム開発。<a href="https://github.com/pop-culture-studio" class="underline underline-offset-2" target="_blank">GitHub</a>
<div class="border rounded my-2">
        <div class="border-b p-2"><span class="font-bold mr-3">料金目安</span>月額11万円(10万円+消費税1万円)</div>
        <div class="border-b p-2"><span class="font-bold mr-3">営業日</span>日曜・祝日と一部の日以外</div>
        <div class="border-b p-2"><span class="font-bold mr-3">営業時間</span>10時から15時</div>
        <div class="p-2"><span class="font-bold mr-3">作業時間</span>営業時間内の一部。目安は月20時間。</div>
        </div>',
    ],
    [
